                ...
                <div class="mod-wrapper clearfix">
                    ...
                    <div class="mod-content clearfix">
                        <div class="mod-inner clearfix">
                            <form name="searchForm" method="post" action="role?action=create">
                                <table>
                                    <tr>
                                        <td width="30%" style="text-align: right; padding-right: 10px;">Tên quyền</td>
                                        <td width="40%"><input type="text" class="inputbox" style="width: 85%" name="rolename" id="rolename" value=""></td>
                                        <td width="20%">
